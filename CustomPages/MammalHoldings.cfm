...
<cfquery name="MammSpecByState" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	select
		count(distinct(cat_num)) cnt,
		continent_ocean,
		country
...
<hr>
<cfquery name="MammSpecAK" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	select
		count(distinct(cat_num)) cnt,
		continent_ocean,
		country
