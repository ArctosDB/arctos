...
<cfloop query="raw">
	<cfquery name="thisRow" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#" cachedwithin="#createtimespan(0,0,60,0)#">
	...
	<cftry>
		...
		<cfif  len(#session.CustomOtherIdentifier#) gt 0>
			<cfquery name="catitem" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#" cachedwithin="#createtimespan(0,0,60,0)#">
