...
<table border>
	...
	<cfquery name="agent_relations" datasource="#Application.web_user#">
		select count(*) cnt from agent_relations where 
			...
			<li>Related to #agent_relations.cnt# other agents</li>
	...
	<cfquery name="publication_author_name" datasource="#Application.web_user#">
		...
		<li>Authored #publication_author_name.cnt# publications</li>
	...
	<cfquery name="entered" datasource="#Application.web_user#">
		select count(*) cnt from coll_object where ENTERED_PERSON_ID =#agent_id#
	</cfquery>
		<li>Entered #entered.cnt# specimens</li>
	<cfquery name="last_edit" datasource="#Application.web_user#">
		select count(*) cnt from coll_object where LAST_EDITED_PERSON_ID =#agent_id#
	</cfquery>
		<li>Edited #last_edit.cnt# specimens</li>
