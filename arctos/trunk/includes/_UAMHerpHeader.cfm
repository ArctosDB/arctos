		...
		<table width="95%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="90" nowrap>
					...
					<a href="http://www.uaf.edu/museum/aqua/index.html"><img src="/images/rana.gif" alt="Arctos" border="0" height="80" width="90"></a>
				</td>
				<td align="left">
					<table>
						<tr>
						...
						<tr>
							<td align="left" nowrap>
							<a href="http://www.uaf.edu/museum/aqua/index.html" >
										<span style="font-family:Arial, Helvetica, sans-serif;  font-size:24px;
		color:##000066;">Herp Collection</span>
									</a>
								<br>
