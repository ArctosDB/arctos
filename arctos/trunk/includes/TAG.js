...
function loadTAG(mid,muri,tid){
	...
	//d+='<input type="text" id="Remark_new" name="Remark_new" size="50" placeholder="Enter a remark or transcription" class="resize">';
...
function scrollToTag(id) {
	...
	setTimeout(function()({$document).scrollTo( $('#' + divID), 800 );}, 1000);
