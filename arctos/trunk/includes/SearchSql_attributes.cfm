...
<cfif isdefined("snv_results")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_snv_results.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(snv_results) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_snv_results.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_snv_results.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("abundance")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_abundance.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(abundance) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_abundance.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_abundance.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("age")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_age.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(age) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_age.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_age.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("age_class")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_age_class.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(age_class) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_age_class.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_age_class.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("appraised_value")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_appraised_value.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(appraised_value) gt 0>
     ...
     <cfif len(temp) gt 0 and listfindnocase(attrunits,temp) and isnumeric(replace(schTerm,temp,""))>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_appraised_value.attribute_value,tbl_appraised_value.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_appraised_value.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_appraised_value.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("axillary_girth")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_axillary_girth.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(axillary_girth) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_axillary_girth.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_axillary_girth.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("body_condition")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_body_condition.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(body_condition) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_body_condition.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_body_condition.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("body_width")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_body_width.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(body_width) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_body_width.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_body_width.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("breadth")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_breadth.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(breadth) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_breadth.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_breadth.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("brood_patch")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_brood_patch.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(brood_patch) gt 0>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_brood_patch.attribute_value,tbl_brood_patch.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_brood_patch.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_brood_patch.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("bursa")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_bursa.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(bursa) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_bursa.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_bursa.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("bursa_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_bursa_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(bursa_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_bursa_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_bursa_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("bursa_width")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_bursa_width.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(bursa_width) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_bursa_width.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_bursa_width.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("carapace_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_carapace_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(carapace_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_carapace_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_carapace_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("caste")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_caste.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(caste) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_caste.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_caste.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("clutch_size")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_clutch_size.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(clutch_size) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_clutch_size.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_clutch_size.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("clutch_size_of_nest_parasite")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_clutch_size_of_nest_parasite.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(clutch_size_of_nest_parasite) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_clutch_size_of_nest_parasite.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_clutch_size_of_nest_parasite.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("colors")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_colors.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(colors) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_colors.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_colors.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("crown_rump_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_crown_rump_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(crown_rump_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_crown_rump_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_crown_rump_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("culmen_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_culmen_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(culmen_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_culmen_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_culmen_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("curvilinear_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_curvilinear_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(curvilinear_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_curvilinear_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_curvilinear_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("depth")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_depth.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(depth) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_depth.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_depth.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("description")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_description.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(description) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_description.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_description.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("diploid_number")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_diploid_number.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(diploid_number) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_diploid_number.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_diploid_number.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("ear_from_crown")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_ear_from_crown.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(ear_from_crown) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_ear_from_crown.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_ear_from_crown.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("ear_from_notch")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_ear_from_notch.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(ear_from_notch) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_ear_from_notch.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_ear_from_notch.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("ectoparasite_examination")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_ectoparasite_examination.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(ectoparasite_examination) gt 0>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_ectoparasite_examination.attribute_value,tbl_ectoparasite_examination.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_ectoparasite_examination.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_ectoparasite_examination.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("ectoparasites_detected")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_ectoparasites_detected.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(ectoparasites_detected) gt 0>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_ectoparasites_detected.attribute_value,tbl_ectoparasites_detected.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_ectoparasites_detected.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_ectoparasites_detected.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("egg_content_weight")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_egg_content_weight.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(egg_content_weight) gt 0>
     ...
     <cfif len(temp) gt 0 and listfindnocase(attrunits,temp) and isnumeric(replace(schTerm,temp,""))>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_egg_content_weight.attribute_value,tbl_egg_content_weight.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_egg_content_weight.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_egg_content_weight.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("eggshell_thickness")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_eggshell_thickness.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(eggshell_thickness) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_eggshell_thickness.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_eggshell_thickness.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("embryo_weight")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_embryo_weight.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(embryo_weight) gt 0>
     ...
     <cfif len(temp) gt 0 and listfindnocase(attrunits,temp) and isnumeric(replace(schTerm,temp,""))>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_embryo_weight.attribute_value,tbl_embryo_weight.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_embryo_weight.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_embryo_weight.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("endoparasite_examination")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_endoparasite_examination.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(endoparasite_examination) gt 0>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_endoparasite_examination.attribute_value,tbl_endoparasite_examination.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_endoparasite_examination.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_endoparasite_examination.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("endoparasites_detected")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_endoparasites_detected.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(endoparasites_detected) gt 0>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_endoparasites_detected.attribute_value,tbl_endoparasites_detected.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_endoparasites_detected.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_endoparasites_detected.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("examined_for_parasites")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_examined_for_parasites.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(examined_for_parasites) gt 0>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_examined_for_parasites.attribute_value,tbl_examined_for_parasites.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_examined_for_parasites.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_examined_for_parasites.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("experimental")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_experimental.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(experimental) gt 0>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_experimental.attribute_value,tbl_experimental.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_experimental.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_experimental.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("extension")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_extension.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(extension) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_extension.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_extension.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("fat_deposition")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_fat_deposition.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(fat_deposition) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_fat_deposition.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_fat_deposition.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("forearm_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_forearm_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(forearm_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_forearm_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_forearm_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("gonad")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_gonad.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(gonad) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_gonad.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_gonad.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("head_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_head_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(head_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_head_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_head_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("head_width")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_head_width.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(head_width) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_head_width.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_head_width.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("height")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_height.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(height) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_height.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_height.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("hind_foot_with_claw")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_hind_foot_with_claw.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(hind_foot_with_claw) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_hind_foot_with_claw.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_hind_foot_with_claw.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("hind_foot_without_claw")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_hind_foot_without_claw.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(hind_foot_without_claw) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_hind_foot_without_claw.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_hind_foot_without_claw.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("hind_limb_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_hind_limb_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(hind_limb_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_hind_limb_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_hind_limb_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("image_confirmed")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_image_confirmed.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(image_confirmed) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_image_confirmed.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_image_confirmed.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("incubation_stage")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_incubation_stage.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(incubation_stage) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_incubation_stage.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_incubation_stage.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("left_gonad_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_left_gonad_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(left_gonad_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_left_gonad_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_left_gonad_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("left_gonad_width")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_left_gonad_width.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(left_gonad_width) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_left_gonad_width.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_left_gonad_width.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("location_in_host")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_location_in_host.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(location_in_host) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_location_in_host.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_location_in_host.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("maximum_standard_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_maximum_standard_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(maximum_standard_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_maximum_standard_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_maximum_standard_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("maximum_total_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_maximum_total_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(maximum_total_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_maximum_total_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_maximum_total_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("middle_toe_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_middle_toe_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(middle_toe_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_middle_toe_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_middle_toe_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("minimum_standard_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_minimum_standard_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(minimum_standard_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_minimum_standard_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_minimum_standard_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("minimum_total_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_minimum_total_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(minimum_total_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_minimum_total_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_minimum_total_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("molt_condition")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_molt_condition.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(molt_condition) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_molt_condition.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_molt_condition.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("neck_width")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_neck_width.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(neck_width) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_neck_width.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_neck_width.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("nest_description")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_nest_description.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(nest_description) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_nest_description.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_nest_description.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("nest_phenology")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_nest_phenology.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(nest_phenology) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_nest_phenology.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_nest_phenology.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("nottitle")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_nottitle.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(nottitle) gt 0>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_nottitle.attribute_value,tbl_nottitle.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_nottitle.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_nottitle.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("number_of_labels")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_number_of_labels.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(number_of_labels) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_number_of_labels.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_number_of_labels.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("numeric_abundance")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_numeric_abundance.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(numeric_abundance) gt 0>
     ...
     <cfif len(temp) gt 0 and listfindnocase(attrunits,temp) and isnumeric(replace(schTerm,temp,""))>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_numeric_abundance.attribute_value,tbl_numeric_abundance.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_numeric_abundance.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_numeric_abundance.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("numeric_age")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_numeric_age.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(numeric_age) gt 0>
     ...
     <cfif len(temp) gt 0 and listfindnocase(attrunits,temp) and isnumeric(replace(schTerm,temp,""))>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_numeric_age.attribute_value,tbl_numeric_age.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_numeric_age.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_numeric_age.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("ovum")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_ovum.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(ovum) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_ovum.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_ovum.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("parasites_found")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_parasites_found.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(parasites_found) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_parasites_found.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_parasites_found.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("parts_examined")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_parts_examined.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(parts_examined) gt 0>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_parts_examined.attribute_value,tbl_parts_examined.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_parts_examined.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_parts_examined.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("plastron_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_plastron_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(plastron_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_plastron_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_plastron_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("purchase_value")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_purchase_value.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(purchase_value) gt 0>
     ...
     <cfif len(temp) gt 0 and listfindnocase(attrunits,temp) and isnumeric(replace(schTerm,temp,""))>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_purchase_value.attribute_value,tbl_purchase_value.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_purchase_value.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_purchase_value.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("reproductive_data")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_reproductive_data.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(reproductive_data) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_reproductive_data.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_reproductive_data.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("right_gonad_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_right_gonad_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(right_gonad_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_right_gonad_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_right_gonad_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("right_gonad_width")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_right_gonad_width.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(right_gonad_width) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_right_gonad_width.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_right_gonad_width.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("sex")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_sex.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(sex) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_sex.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_sex.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("skull_ossification")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_skull_ossification.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(skull_ossification) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_skull_ossification.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_skull_ossification.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("snout_vent_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_snout_vent_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(snout_vent_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_snout_vent_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_snout_vent_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("soft_part_color")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_soft_part_color.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(soft_part_color) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_soft_part_color.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_soft_part_color.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("soft_parts")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_soft_parts.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(soft_parts) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_soft_parts.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_soft_parts.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("standard_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_standard_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(standard_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_standard_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_standard_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("stomach_contents")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_stomach_contents.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(stomach_contents) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_stomach_contents.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_stomach_contents.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("tail_base_width")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_tail_base_width.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(tail_base_width) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_tail_base_width.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_tail_base_width.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("tail_condition")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_tail_condition.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(tail_condition) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_tail_condition.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_tail_condition.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("tail_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_tail_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(tail_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_tail_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_tail_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("tarsus_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_tarsus_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(tarsus_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_tarsus_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_tarsus_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("total_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_total_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(total_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_total_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_total_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("tragus_length")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_tragus_length.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(tragus_length) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_tragus_length.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_tragus_length.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("trap_identifier")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_trap_identifier.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(trap_identifier) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_trap_identifier.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_trap_identifier.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("trap_type")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_trap_type.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(trap_type) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_trap_type.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_trap_type.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("unformatted_measurements")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_unformatted_measurements.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(unformatted_measurements) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_unformatted_measurements.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_unformatted_measurements.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("verbatim_host_id")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_verbatim_host_id.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(verbatim_host_id) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_verbatim_host_id.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_verbatim_host_id.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("verbatim_host_age")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_verbatim_host_age.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(verbatim_host_age) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_verbatim_host_age.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_verbatim_host_age.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("verbatim_host_sex")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_verbatim_host_sex.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(verbatim_host_sex) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_verbatim_host_sex.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_verbatim_host_sex.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("verbatim_preservation_date")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_verbatim_preservation_date.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(verbatim_preservation_date) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_verbatim_preservation_date.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_verbatim_preservation_date.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("weight")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_weight.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(weight) gt 0>
     ...
     <cfif len(temp) gt 0 and listfindnocase(attrunits,temp) and isnumeric(replace(schTerm,temp,""))>
      ...
      <cfif len(schunits) gt 0>
         <cfset basQual = " #basQual# AND to_meters(tbl_weight.attribute_value,tbl_weight.attribute_units) #oper# to_meters(#schTerm#,'#schunits#')">
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_weight.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_weight.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("width")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_width.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(width) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_width.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_width.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>
...
<cfif isdefined("wing_chord")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_wing_chord.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(wing_chord) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_wing_chord.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_wing_chord.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>

<cfif isdefined("wing_span")>
    ...
    <cfif session.flatTableName is not "flat">
        <cfset basQual = " #basQual# AND tbl_wing_span.is_encumbered = 0">
    </cfif>
    <cfset schunits="">
    <cfif len(wing_span) gt 0>
     ...
     <cfelseif oper is not "like" and len(schunits) is 0>
         <cfset basQual = " #basQual# AND upper(tbl_wing_span.attribute_value) #oper# '#escapeQuotes(schTerm)#'">
     <cfelse>
         <cfset basQual = " #basQual# AND upper(tbl_wing_span.attribute_value) like '%#ucase(escapeQuotes(schTerm))#%'">
     </cfif>
    </cfif>
</cfif>