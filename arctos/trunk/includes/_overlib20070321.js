...
function getAgent(agentIdFld,agentNameFld,formName,agentNameString){
var url="/picks/findAgent.cfm";
var agentIdFld;
var agentNameFld;
var formName;
var agentNameString;
var oawin=url+"?agentIdFld="+agentIdFld+"&agentNameFld="+agentNameFld+"&formName="+formName+"&agent_name="+agentNameString;
...
function loanHelp(help) {
	var help;
	helpWin=windowOpener("/info/loanhelp.cfm?content="+help,"helpWin","width=400,height=338, resizable,scrollbars")
	}
...
function getSiteHelp() {
	SiteHelpWin=windowOpener("/help/SiteHelp.cfm","SiteHelpWin","width=800,height=638, resizable,scrollbars,location,status,menubar")
	}	
...
function getInfo(subject,id) {
	var subject;
	var id;
	infoWin=windowOpener("/info/SpecInfo.cfm?subject="+subject+"&id="+id,"infoWin","width=800,height=500, resizable,scrollbars")
	}
...
function writeLog(page,coll,cnt){
var page;
var coll;
var cnt;
var logurl="/includes/writeLog.cfm?page="+page+"&coll="+coll+"&cnt="+cnt;
logwin=window.open(logurl,"","width=1,height=1")
}
...
************************************************************************************************/
/* 
	call this function from anywhere in the body of the page
	Three parameters are required - agentIdFld, agentNameFld, and formName
	These are the fields that get the return values in the return form from the agent pick form.
	Call the function with code similar to
	<a href="##" onClick="openpopup('agent_id','agent_name','loan'); return false;">pick agent</a>
*/
