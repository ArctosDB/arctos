		...
		<table width="95%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="85" nowrap>
					...
					<!---<img src="/images/MSB_headerIcon.gif" border="0">
					--->
					<img src="/images/MSB_trans2.gif" border="0">
					</a>
				</td>
				<td align="left">
					<table>
						...
						<tr>
							<td align="left" nowrap>
							<a href="http://www.unm.edu/" target="_blank" style=" text-decoration:none;"  >
										<span style="font-family:Arial, Helvetica, sans-serif;  font-size:14px;
		color:##990000;" onMouseOver="this.style.textDecoration='underline';" onMouseOut="this.style.textDecoration='none';">University of New Mexico</span>
									</a>
								<br>
									
									<a href="http://www.msb.unm.edu/" target="_blank"  style=" text-decoration:none;"
									>
										<span style="font-family:Arial, Helvetica, sans-serif;
		color:##990000; font-size:24px;
		font-weight:bold;" onMouseOver="this.style.textDecoration='underline';" onMouseOut="this.style.textDecoration='none';">Museum of Southwestern Biology</span>
