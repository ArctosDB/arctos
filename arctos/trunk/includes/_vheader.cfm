...
<table border cellpadding="0" cellspacing="0" style="background-color:##FFFFFF; position:absolute; top:0px; right:0px; font-size:12px;">
		...
		<tr>
			...
			<td>&nbsp;<a href="/user_loan_request.cfm" target="_top" class="novisit">Loans</a>&nbsp;</td>
		...
		<tr>
			...
			<form name="qs" method="post" action="veritySearch.cfm">
				<input type="hidden" name="action" value="showResults">
				<input type="text"  name="criteria" size="15" maxLength="50" class="hSearch">
				<input type="submit" value="GO" class="hBtn"
					onmouseover="this.className='hBtn btnhov'"
					onmouseout="this.className='hBtn'">
...
<!----border-bottom-style:solid; border-bottom-color:#000000; border-bottom-width:thin;---->
	...
	<div style="padding-left:25px; ">
		...
		color:##000066; 
		font-weight:bold;">Multi-Institution, Multi-Collection Museum Database</span>
