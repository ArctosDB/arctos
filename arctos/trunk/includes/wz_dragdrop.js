...
dd.getEventTarget = function(d_e, d_s, d_n)
{
	...
	if(d_e && (d_s = d_e.target || d_e.srcElement || null) != null)
	{
		...
		{
			if(d_n.indexOf("divnimg") == d_n.length-7)
				return dd.elements[d_n.substring(0, d_n.length-7)] || null;
			if(d_n.indexOf("div") == d_n.length-3)
				return dd.elements[d_n.substring(0, d_n.length-3)] || null;
