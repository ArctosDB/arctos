...
function ToggleDisplay(id){var elem=document.getElementById(id);if(elem){if(elem.style.display!='block'){elem.style.display='block';elem.style.visibility='visible';whurUB();}
else{elem.style.display='none';elem.style.visibility='hidden';ubGone();}}}