...
<cfoutput>
	...
	<div class="outer">
		...
		<cfif isdefined("locality_id") or isdefined("collecting_event_id")>
			...
			<cfquery name="locMedia" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
				select 
					media_id
				from 
					media_relations 
			...
			<cfquery name="locSpecimen" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
				SELECT 
		...
		<cfif isdefined("collecting_event_id")>
			...
			<cfquery name="evntMedia" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
				select 
					media_id
				from 
					media_relations 
			...
			<cfquery name="evntSpecimen" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
				SELECT 
					count(cataloged_item.cat_num) numOfSpecs, 
					collection.collection,
					collection.collection_id
