...
<cffunction name="getContDetails" access="remote">
	...
	<cftry>
		<cfquery name="queriedFor" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#" timeout="60">
			SELECT 
				CONTAINER_ID,
				PARENT_CONTAINER_ID,
				CONTAINER_TYPE,
...
<cffunction name="get_containerContents" access="remote">
	...
	<cftry>
		<cfquery name="result" timeout="60" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
			SELECT 
				CONTAINER_ID,
				PARENT_CONTAINER_ID,
				CONTAINER_TYPE,
