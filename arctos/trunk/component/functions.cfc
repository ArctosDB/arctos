<cfcomponent>
	<!----
				...
				---->
<cffunction name="getLocalityDetails" access="remote">
	<cfargument name="localityID" type="numeric" required="yes">
	<cftry>
 ...
 BEGAN_DATE									     NOT NULL DATE
 ENDED_DATE									     NOT NULL DATE
 VERBATIM_DATE									     NOT NULL VARCHAR2(60)
 VERBATIM_LOCALITY									      VARCHAR2(255)
 COLL_EVENT_REMARKS									      VARCHAR2(255)
 VALID_DISTRIBUTION_FG									      NUMBER
 COLLECTING_SOURCE								     NOT NULL VARCHAR2(15)
