	...
	<cfif isdefined("request.rdurl") and (
		...
		<cfif IsDefined("Cookie.dorm")>
			...
			<cfelse>
	          ...
	          <cfset r=r & '::have NON-mobile cookie: redirect to /{notm}....'>
			</cfif>
		<cfelse>
		  <!----
		      ...
		      If they're on a mobile device and a mobile page, do nothing.
		      If they're on a desktop device and a desktop page, do nothing.
              If they're on a desktop device and a mobile page, send them to desktop.
		  ---->
