...
<cfset headerClass="times11">
<cfset textClass="times10">
<cfset divWidth=190>
<cfset divHeight=97>
<cfset titleTop=3>
<cfset titleLeft=0>
<cfset titleWidth=190>
<cfset titleHeight=20>
<cfset catnumTop=16>
<cfset catnumLeft=2>
<cfset catnumWidth=80>
...
<cfset scigeogTop=25>
<cfset scigeogLeft=0>
<cfset scigeogWidth=190>
<cfset scigeogHeight=35>
<cfset sciPadding=0>
<cfset dateCollTop=77>
<cfset dateLeft=1>
<cfset dateWidth=70>
<cfset dateHeight=10>
...
<cfloop query="data">
	...
	<cftry><cfif not isdefined('$#collection_object_id#$')>
		...
		<cfif #i# is numRows*numCols>
			...
			<br/>
			<!--- Removing the pagebreak because we are getting extra pages
			in between the label pages for some reason.... Peter DeVore 11/13/07
...
<cfset title='Wide Labels Parameters'>
...
<!---<cfset sql="
	...
	WHERE
		accepted_id_fg=1 AND cataloged_item.collection_object_id IN (#collection_object_id#)
">
<cfquery name="geogQuery" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
	#preservesinglequotes(sql)#
</cfquery>--->
...
<cfset sql="
	...
	ORDER BY
		cat_num
">
<cfquery name="partsQuery" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
	#preservesinglequotes(sql)#
</cfquery>
<!--- end get data for parts--->
<cfoutput>
<h3>Specify your parameters</h3>
<form action='wideLabels.cfm' method='post'>
