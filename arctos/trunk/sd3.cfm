...
<div class="taMenu">				
	<ul>
		<cfif #isMS# is "t">
			<li<cfif #content_url# is "editIdentification.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='editIdentification.cfm';incPg.submit();"><span>Taxa</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='addAccn.cfm';incPg.submit();"><span>Accn</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='Locality.cfm';incPg.action.value='editCollEvnt';incPg.submit();"><span>Edit Locn.</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='changeCollEvent.cfm';incPg.submit();"><span>New Locn.</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='editColls.cfm';incPg.submit();"><span>Agents</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='editRelationship.cfm';incPg.submit();"><span>Relations</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='editParts.cfm';incPg.submit();"><span>Parts</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:window.open('Locations.cfm?collection_object_id=#collection_object_id#&srch=part','parts');"><span>Part Locn.</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='editBiolIndiv.cfm';incPg.submit();"><span>Attributes</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='editIdentifiers.cfm';incPg.submit();"><span>IDs</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='editImages.cfm';incPg.submit();"><span>Images</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='Encumbrances.cfm';incPg.submit();"><span>Encumbrances</span></a>
			</li>
		<cfelse><!---- non-MS - yea! ---->
			<li<cfif #content_url# is "editIdentification.cfm"> id="current"</cfif>>
				<a href="javascript:void(0);" onClick="incPg.content_url.value='editIdentification.cfm';incPg.submit();"><span>Taxa</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:void(0);" onClick="incPg.content_url.value='addAccn.cfm';incPg.submit();"><span>Accn</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:void(0);" onClick="incPg.content_url.value='Locality.cfm';incPg.action.value='editCollEvnt';incPg.submit();"><span>Edit Locn.</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:void(0);" onClick="incPg.content_url.value='changeCollEvent.cfm';incPg.submit();"><span>New Locn.</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:void(0);" onClick="incPg.content_url.value='editColls.cfm';incPg.submit();"><span>Agents</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:void(0);" onClick="incPg.content_url.value='editRelationship.cfm';incPg.submit();"><span>Relations</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:void(0);" onClick="incPg.content_url.value='editParts.cfm';incPg.submit();"><span>Parts</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:void(0);" onClick="window.open('Locations.cfm?collection_object_id=#collection_object_id#&srch=part','parts');"><span>Part Locn.</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:void(0);" onClick="incPg.content_url.value='editBiolIndiv.cfm';incPg.submit();"><span>Attributes</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:void(0);" onClick="incPg.content_url.value='editIdentifiers.cfm';incPg.submit();"><span>IDs</span></a>
			</li>
			<li<cfif #content_url# is "addAccn.cfm"> id="current"</cfif>>
				<a href="javascript:incPg.content_url.value='editImages.cfm';incPg.submit();"><span>Images</span></a>
			</li>
