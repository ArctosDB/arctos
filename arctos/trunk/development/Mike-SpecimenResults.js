                        ...
                        theInnerHtml += '<div class="shortThumb"><div class="thumb_spcr">&nbsp;</div>';
                            ...
                            for (m=0; m<thisMedia.ROWCOUNT; ++m) {
                                ...
                                if (thisMedia.DATA.mimecat[m] != 'audio') {
									...
									theInnerHtml += '<div id="jquery_jplayer_1" class="jp-jplayer"><audio id="jp_audio_0" preload="metadata" src="http://www.jplayer.org/audio/m4a/Miaow-07-Bubble.m4a"></audio></div><div class="jp-audio"><div class="jp-type-single"><div id="jp_interface_1" class="jp-interface"><ul class="jp-controls">' +
