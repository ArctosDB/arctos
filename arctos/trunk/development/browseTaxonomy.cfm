...
<cfquery name="class" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cfloop query="class">
	...
	<span>
		...
		<!--- expand children ---->
			<cfquery name="order" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	...
	<span>
		...
		<cfif #currentOrder# is not "NOT RECORDED">
			<br><font size="-2">Click to search Arctos for #currentOrder#</font>
						...
						<cfquery name="suborder" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	...
	<span>
		...
		<cfif #currentSuborder# is not "NOT RECORDED">
			<br><font size="-2">Click to search Arctos for #currentSuborder#</font>
						...
						<cfquery name="family" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	...
	<span>
		...
		<cfif #currentFamily# is not "NOT RECORDED">
			<br><font size="-2">Click to search Arctos for #currentFamily#</font>
						...
						<cfquery name="subfamily" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	...
	<span>
		...
		<cfif #currentSubfamily# is not "NOT RECORDED">
			<br><font size="-2">Click to search Arctos for #currentSubfamily#</font>
											...
											<cfquery name="genus" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	...
	<span>
		...
		<cfif #currentGenus# is not "NOT RECORDED">
			<br><font size="-2">Click to search Arctos for #currentGenus#</font>
													...
													<cfquery name="species" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	...
	<span>
		...
		<cfif #currentSpecies# is not "NOT RECORDED">
			<br><font size="-2">Click to search Arctos for <i>#currentGenus# #currentSpecies#</i></font>
															...
															<cfquery name="subspecies" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
