...
<cfinclude template="trunk/includes/_header.cfm">
...
<script src="trunk/includes/jquery/jquery-autocomplete/jquery.autocomplete.pack.js" language="javascript" type="text/javascript"></script>
...
<cfquery name="hasCanned" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,cfid)#">
	...
	and URL like '%Mike-SpecimenResults.cfm%'
...
<cfinclude template = "trunk/includes/_footer.cfm">