...
<ul id="navigation">				
<!----	
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='SpecimenDetail_main.cfm';submit();">Detail</span></a></li>
---->
<!---- edit for shorter titles
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='editIdentification.cfm';submit();">Taxonomy</span></a></li>
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='addAccn.cfm';submit();">Accession</span></a></li>
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='Locality.cfm';incPg.action.value='editCollEvnt';submit();">Edit Coll Event</span></a></li>
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='changeCollEvent.cfm';submit();">Change Coll Event</span></a></li>
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='editColls.cfm';submit();">Collectors</span></a></li>
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='editRelationship.cfm';submit();">Relationships</span></a></li>
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='editParts.cfm';submit();">Parts</span></a></li>
...
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='editBiolIndiv.cfm';submit();">Individual Attributes</span></a></li>
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='editIdentifiers.cfm';submit();">Identifiers</span></a></li>
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='editImages.cfm';submit();">Images</span></a></li>
<li><a href="javascript:void(0);"><span onClick="incPg.content_url.value='Encumbrances.cfm';submit();">Encumbrances</span></a></li>
--->
...
<tr height="1">
	<td>
		<img src="/images/nada.gif" border="0" height="2">
	</td>
</tr>
