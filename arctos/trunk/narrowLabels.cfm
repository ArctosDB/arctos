...
<cfdocument
        ...
        filename="#Application.webDirectory#/temp/narrowlabels_#left(session.sessionKey,10)#.pdf" orientation="portrait" >
...
<a href="/temp/narrowlabels_#left(session.sessionKey,10)#.pdf">Get the PDF</a><br />
