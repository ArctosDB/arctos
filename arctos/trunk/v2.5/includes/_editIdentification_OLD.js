...
function newIdFormula (f) {
	...
	if (f == 'A or B' || f == 'A x B' || f == 'A / B intergrade' || f == 'A and B') {
		// a and b
		var bTr = document.getElementById('taxon_b_row').style.display='';
	} else if (f == 'A' || f == 'A ?' || f == 'A cf.' || f == 'A sp.' || f == 'A aff.' || f == 'A ssp.') {
		var bTr = document.getElementById('taxon_b_row').style.display='none';
		var bTr = document.getElementById('taxa_b').style.value='';
		var bTr = document.getElementById('TaxonBID').style.value='';
