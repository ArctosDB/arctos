...
<cfdocument
		...
		unit="in"
        orientation="landscape" filename="#Application.webDirectory#/temp/report_#left(session.sessionKey,10)#.pdf" overwrite="true">
...
<a href="/temp/report_#left(session.sessionKey,10)#.pdf">Get the PDF</a><br />
</cfoutput>
