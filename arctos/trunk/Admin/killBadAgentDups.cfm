...
<hr>
<cfset nogo="false">
<cfquery name="name" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
...
<cfquery name="isGoodRelated" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
	select agent_type 
...
<cfquery name="project_agent" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
...
<cfquery name="publication_author_name" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
...
---->		
<cfquery name="agent_relations" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
...
<cfif #agent_relations.cnt# gt 0>
	...
	<cfquery name="relAgent" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
...
<cfquery name="electronic_address" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
