		...
		<cfif len(last) gt 0>
			<cfquery name="isthere" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
				...
				<cfif isThere.recordcount is 0>
					...
					<cfquery name="inssta" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
							INSERT INTO addr (
							ADDR_ID
							,STREET_ADDR1
							,STREET_ADDR2
					...
					<cfif len(phone) gt 0>
						<cfquery name="inssea" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
					...
					<cfif len(email) gt 0>
						<cfquery name="inssem" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
							INSERT INTO electronic_address (
								AGENT_ID
								,address_type
							 	,address	
