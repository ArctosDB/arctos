...
<table border cellpadding="0" cellspacing="0">
	<tr>
		<cfloop query="getCols">
			<td><span style="font-size:10px">
				<cfif #column_name# is "collection_object_id">ID<cfelse>#column_name#</cfif>
				</span>
			</td>
		</cfloop>
	</tr>
	<cfset noChangeList = "collection_object_id,ENTEREDBY">
	<cfset shortDataList = "began_date,ended_date,verbatim_date,minimum_elevation,maximum_elevation,determined_date,max_error_distance,dec_lat,dec_long,DEC_LAT_MIN,DEC_LONG_MIN,LATDEG,LATMIN,LATSEC,LONGDEG,LONGMIN,LONGSEC,MADE_DATE,ACCN,MIN_DEPTH,MAX_DEPTH,VESSEL,STATION_NAME,STATION_NUMBER,COLL_OBJECT_HABITAT,ASSOCIATED_SPECIES,PART_CONTAINER_LABEL_,PART_BARCODE_,PART_LOT_COUNT_,ATTRIBUTE_DATE_,ATTRIBUTE_DET_METH_">
	<cfset medDataList="COLL_EVENT_REMARKS,SPEC_LOCALITY,LOCALITY_REMARKS,DATUM,LAT_LONG_REMARKS,VERBATIM_LOCALITY,HABITAT_DESC,COLL_OBJ_DISPOSITION,CONDITION,COLL_OBJECT_REMARKS,DISPOSITION_REMARKS,IDENTIFICATION_REMARKS,LOADED,OTHER_ID_NUM_,PART_CONDITION_,ATTRIBUTE_VALUE_,ATTRIBUTE_UNITS_,ATTRIBUTE_REMARKS_">
	<cfset agentList="DETERMINED_BY_AGENT,ID_MADE_BY_AGENT,COLLECTOR_AGENT_,ATTRIBUTE_DETERMINER_">
	...
	<cfloop query="data">
		...
		<tr>
			<cfloop query="getCols">
				...
				<cfset thisName = "#column_name#__#thisRec.collection_object_id#">
				<CFSET i=#column_name#>
				<td align="right">
					<cfif ListFindNoCase(noChangeList,i)>
							<!--- do not allow changes --->
							<input type="text" id="#thisName#" name="#thisName#" value="#thisData#" readonly="yes" size="6" />					
					<cfelseif ListFindNoCase("cat_num",i,",")>
						<input type="text" id="#thisName#" 
							name="#thisName#" value="#thisData#" size="6"  
							class="unchanged" onchange="this.className='changed';updateData('#thisName#',this.value);" />
					<cfelseif ListFindNoCase(shortDataList,rereplace(i,'[0-9]+',''),",")>
						<input type="text" id="#thisName#" name="#thisName#" 
							value="#thisData#" size="10" class="unchanged" 
							onchange="this.className='changed';updateData('#thisName#',this.value)" />
					<cfelseif ListFindNoCase(medDataList,rereplace(i,'[0-9]+',''),",")>
						<input type="text" id="#thisName#" name="#thisName#" 
							value="#thisData#" size="30" class="unchanged" 
							onchange="this.className='changed';updateData('#thisName#',this.value);" />
					<cfelseif ListFindNoCase("HIGHER_GEOG",i,",")>
						<input type="text" name="#thisName#" 
							value="#thisData#" size="50" class="unchanged"
							onchange="getGeog('nothing','#thisName#','blData',this.value); 
							return false;this.className='changed';updateData('#thisName#',this.value);" />
					<cfelseif ListFindNoCase("ORIG_ELEV_UNITS",i,",")>
					...
					<cfelseif ListFindNoCase("ORIG_LAT_LONG_UNITS",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("LAT_LONG_REF_SOURCE",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("LAT_LONG_UNITS",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("MAX_ERROR_UNITS",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("LATDIR",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("LONGDIR",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("COLLECTOR_ROLE_",rereplace(i,'[0-9]+',''),",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("PART_NAME_",rereplace(i,'[0-9]+',''),",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
							...
							<cfloop query="CTSPECIMEN_PART_NAME">
								<option 
									<cfif ListFindNoCase(thisData,PART_NAME)>
									selected </cfif>
									value="#PART_NAME#">#PART_NAME#</option>
							</cfloop>
						</select>
					<cfelseif ListFindNoCase("PART_MODIFIER_",rereplace(i,'[0-9]+',''),",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("PRESERV_METHOD_",rereplace(i,'[0-9]+',''),",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("COLL_OBJ_DISPOSITION",i,",")>	
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("INSTITUTION_ACRONYM",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("NATURE_OF_ID",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("COLLECTION_CDE",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("FLAGS",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("GEOREFMETHOD",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("COLLECTING_METHOD",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("VERIFICATIONSTATUS",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("DEPTH_UNITS",i,",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("OTHER_ID_NUM_TYPE_",rereplace(i,'[0-9]+',''),",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("ATTRIBUTE_",rereplace(i,'[0-9]+',''),",")>
						<select name="#thisName#" 
							size="1" 
							id="#thisName#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase(agentList,rereplace(i,'[0-9]+',''),",")>
						<input type="text"
							name="#thisName#" 
							value="#thisData#" 
							class="unchanged" 
					...
					<cfelseif ListFindNoCase("TAXON_NAME",i,",")>
							<input 
								type="text" 
								name="#thisName#" 
								value="#thisData#" 
	...
	<cfloop query="data">
		...
		<td align="right">
				...
				<cfset thisName = "#getCols.column_name#__#data.collection_object_id#">
				<cfset i=#getCols.column_name#>
