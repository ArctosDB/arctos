...
<table border cellpadding="0" cellspacing="0">
	...
	<cfset shortDataList = "cat_num,began_date,ended_date,verbatim_date,minimum_elevation,maximum_elevation,determined_date,max_error_distance,dec_lat,dec_long,DEC_LAT_MIN,DEC_LONG_MIN,LATDEG,LATMIN,LATSEC,LONGDEG,LONGMIN,LONGSEC,MADE_DATE,ACCN,MIN_DEPTH,MAX_DEPTH,VESSEL,STATION_NAME,STATION_NUMBER,COLL_OBJECT_HABITAT,ASSOCIATED_SPECIES,PART_CONTAINER_LABEL_,PART_BARCODE_,PART_LOT_COUNT_,ATTRIBUTE_DATE_,ATTRIBUTE_DET_METH_,ORIG_ELEV_UNITS,ORIG_LAT_LONG_UNITS,MAX_ERROR_UNITS,LATDIR,LONGDIR,COLLECTOR_ROLE_,INSTITUTION_ACRONYM,COLLECTION_CDE,DEPTH_UNITS">
	
	<cfset medDataList="COLL_EVENT_REMARKS,SPEC_LOCALITY,LOCALITY_REMARKS,DATUM,LAT_LONG_REMARKS,VERBATIM_LOCALITY,HABITAT_DESC,COLL_OBJ_DISPOSITION,CONDITION,COLL_OBJECT_REMARKS,DISPOSITION_REMARKS,IDENTIFICATION_REMARKS,LOADED,OTHER_ID_NUM_,PART_CONDITION_,ATTRIBUTE_VALUE_,ATTRIBUTE_UNITS_,ATTRIBUTE_REMARKS_,DETERMINED_BY_AGENT,ID_MADE_BY_AGENT,COLLECTOR_AGENT_,ATTRIBUTE_DETERMINER_,LAT_LONG_REF_SOURCE,LAT_LONG_UNITS,PART_MODIFIER_,PART_NAME_,PRESERV_METHOD_,COLL_OBJ_DISPOSITION,NATURE_OF_ID,FLAGS,GEOREFMETHOD,COLLECTING_METHOD,VERIFICATIONSTATUS,OTHER_ID_NUM_TYPE_,ATTRIBUTE_,TAXON_NAME">
	
	<cfset longDataList = "HIGHER_GEOG">
	<cfset agentList="">
				...
				<td align="right">
					...
					<cfelseif ListFindNoCase(medDataList,rereplace(i,'[0-9]+',''),",")>
						<input type="text" id="#thisName#" name="#thisName#" 
							...
							onchange="this.className='changed';updateData('#thisName#',this.value);" />
					<cfelseif ListFindNoCase(longDataList,rereplace(i,'[0-9]+',''),",")>
						<input type="text" id="#thisName#" name="#thisName#" 
							value="#thisData#" size="60" class="unchanged" 
							onchange="this.className='changed';updateData('#thisName#',this.value);" />
					</cfif>
					<!---
