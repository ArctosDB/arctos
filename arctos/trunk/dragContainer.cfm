...
<div style="background-color:#FF0000">
	This application doesn't actually do anything. Play with it. If you think it'll do what you need, talk to DLM and we'll turn it on.
	<br />You can:
	<ul>
		<li>Find parts or containers on both sides</li>
		<li>Check/Uncheck to see details, go to other applications</li>
		<li>Drag things around inside and between sides (the part that's disabled)</li>
	</ul>
</div>
