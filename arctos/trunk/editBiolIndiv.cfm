...
<cfif action is "nothing">
	...
	<cfoutput>
		<cfquery name="raw" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
			SELECT
				COLL_OBJECT_REMARKS,
				habitat,
				associated_species,
		...
		<cfquery name="ctflags" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
		...
		<form name="details" method="post" action="editBiolIndiv.cfm">
			...
			<cfif indiv.collection_cde is "Mamm">
				<cfquery name="ctlength_units" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
					select length_units from ctlength_units order by length_units
				</cfquery>
				<cfquery name="ctweight_units" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
		...
		<cftransaction>
			<cfloop from="1" to="#number_Of_Attributes#" index="n">
				...
				<cfif thisAttributeType is "pending delete">
					<cfquery name="killAtt" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
			...
			<cfif isdefined("total_length")>
				<cfif len(total_length) gt 0>
					<cfquery name="total_length" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
				...
				<cfif len(tail_length) gt 0>
					<cfquery name="tail_length" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
						INSERT INTO attributes (
							ATTRIBUTE_ID
							,COLLECTION_OBJECT_ID
							,DETERMINED_BY_AGENT_ID
				...
				<cfif len(hind_foot_with_claw) gt 0>
					<cfquery name="hind_foot_with_claw" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
						INSERT INTO attributes (
							ATTRIBUTE_ID
							,COLLECTION_OBJECT_ID
							,DETERMINED_BY_AGENT_ID
				...
				<cfif len(ear_from_notch) gt 0>
					<cfquery name="ear_from_notch" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
						INSERT INTO attributes (
							ATTRIBUTE_ID
							,COLLECTION_OBJECT_ID
							,DETERMINED_BY_AGENT_ID
				...
				<cfif len(weight) gt 0>
					<cfquery name="weight" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
						INSERT INTO attributes (
							ATTRIBUTE_ID
							,COLLECTION_OBJECT_ID
							,DETERMINED_BY_AGENT_ID
			...
			<cfif len(attribute_type_new) gt 0>
				...
				<cfquery name="newAtt" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
					INSERT INTO attributes (
						ATTRIBUTE_ID
						,COLLECTION_OBJECT_ID
						,DETERMINED_BY_AGENT_ID
			...
			<cfquery name="upCollObj" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
			...
			<cfquery name="isCORem" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
				select collection_object_id from coll_object_remark where 
				collection_object_id = #collection_object_id#
			</cfquery>
			<cfif len(isCORem.collection_object_id) gt 0>
				<cfquery name="upCoRem" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
			...
			<cfelse>
				<cfif len(coll_object_remarks) gt 0 OR len(habitat) gt 0 or len(associated_species) gt 0>
					<cfquery name="newBIRem" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
