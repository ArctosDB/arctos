...
Return TempList;
  ...
  <cfif #action# is "update">
	...
	--->
    <cfquery name="getBarcodes" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
    ...
    <cfoutput> 
      ...
      <cfquery name="getChildId" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
    ...
    <cfif badCount gt 0>
      ...
      <cfquery name="exists" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
      ...
      <cfoutput> 
        ...
        <cfquery name="getParentId" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
      ...
      <cfloop query="allData">
        <cftransaction>
          <cfoutput> 
            ...
            <cfquery name="setParents" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
            ...
            <cfquery name=setType datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
            ...
            <cfif #isThere.recordcount# is 0>
              <cfquery name="setHistory" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
