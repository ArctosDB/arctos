...
<cffunction name="agent_lookup" returntype="Any">
	...
	<cftry>
		<cfquery name="aid" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
			SELECT 
				agent_id,
				'#v_f#' v_f,
				'#i_f#' i_f,
...
<cffunction name="removeItems" returntype="string">
	...
	<cfoutput>
	<cfquery name="remove" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<!--------------
	<cftry>
		<cfquery name="tieRef" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cffunction name="clientResultColumnList" returntype="string">
	...
	<cfquery name ="upDb" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<!------------------------------------->
 <cffunction name="deleteIdentification" returntype="string">
	...
	<cftry>
		<cftransaction>
			<cfquery name="delIdTax" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
				delete from identification_taxonomy where 
				identification_id=#identification_id#
			</cfquery>
			<cfquery name="delIdA" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
				delete from identification_agent where 
				identification_id=#identification_id#
			</cfquery>	
			<cfquery name="delId" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<!------------------------------------->
 <cffunction name="flippedAccepted" returntype="string">
	...
	<cfargument name="identification_id" type="numeric" required="yes">
	<cftry>
		<cfquery name="flipOld" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
			update identification set accepted_id_fg=0
			where
			collection_object_id=#collection_object_id#
		</cfquery>
		<cfquery name="newIdentifier" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cffunction name="moveContainerLocation" returntype="string">
	...
	<cftry>
		...
		<cftransaction>
			<cfquery name="alterTime" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cffunction name="getPreviousBox" returntype="query">
	...
	<cfif #box# is 1>
		<cfif #rack# is 1>
			...
			<cfelse>
				<cfset tf = #freezer# -1 >
				<cfquery name="pf" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	...
	<cfquery name="v" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cffunction name="getCollInstFromCollId" returntype="string">
	...
	<cftry>
		<cfquery name="getCollId" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
