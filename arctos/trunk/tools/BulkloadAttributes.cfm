...
<cfoutput>
	...
	<cfloop query="data">
		...
		<cfif #other_id_type# is "catalog number">
			...
			<cfquery name="isAtt" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
			...
			<cfquery name="isValCt" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
				...
				attribute_type = '#trim(attribute)#'
					...
					<cfif len(#attribute_units#) gt 0>
						<cfquery name="isUnitCt" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
		  ...
		  <cfelse>
				 ...
				 <cfelse>
					...
					<cfif len(#determiner#) gt 0>
						<cfquery name="attDet1" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
						...
						<cfquery name="gotDet" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
