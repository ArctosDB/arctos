...
<cfoutput>
	...
	<cfloop index="line" list="#fileContent#" delimiters="#chr(10)#">
		...
		<cfset sql = "#i#,#sql#">
		<cfset i=#i#+1>
		<cfquery name="newRec" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
...
<cfoutput>
	...
	<cfloop query="getTempData">
		...
		--->
		<cfstoredproc procedure="parse_other_id" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
