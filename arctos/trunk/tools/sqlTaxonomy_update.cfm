...
<cfoutput>
		<form name="buildIt" method="post" action="sqlTaxonomy_update.cfm">
			...
			Build SQL...
			<cfset fldList = "TAXON_NAME_ID,PHYLUM,PHYLCLASS,PHYLORDER,SUBORDER,FAMILY,SUBFAMILY,TRIBE,GENUS,SUBGENUS,SPECIES,INFRASPECIFIC_RANK,SUBSPECIES,VALID_CATALOG_TERM_FG,SOURCE_AUTHORITY,FULL_TAXON_NAME,SCIENTIFIC_NAME,AUTHOR_TEXT,TAXON_REMARKS">
			<cfset upList = "PHYLUM,PHYLCLASS,PHYLORDER,SUBORDER,FAMILY,SUBFAMILY,TRIBE,GENUS,SUBGENUS,SPECIES,INFRASPECIFIC_RANK,SUBSPECIES,VALID_CATALOG_TERM_FG,SOURCE_AUTHORITY,AUTHOR_TEXT,TAXON_REMARKS">
...
<cfif #action# is "testUpdate">
	<cfoutput>
	<cfquery name="test" datasource="#Application.web_user#">
