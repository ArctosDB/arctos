...
<cfset title="Loan By Container">
<cfif action is "nothing">
Use this form to loan all contents of a container.
	<form name="f" method="post" action="">
		<input type="hidden" name="Action" value="findContainer">
		<label for="barcode">Barcode (of box, tray, cabinet, etc.)</label>
...
<cfif action is "lookup">
	<cfquery name="collObj" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
		...
		start with 
			partcontainer.container_id=#container_id#
		connect by 
