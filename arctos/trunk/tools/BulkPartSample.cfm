...
<cfoutput>
	<cfquery name="template" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
...
<cfoutput>
	...
	<cfloop query="d">
		...
		<cfquery name="container" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
		...
		<cfquery name="pPart" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
		...
		<cfquery name="status" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
...
<cfoutput>
	...
	<cfloop query="getTempData">
		...
		<cfelse><!--- parent lot count check --->
			<cfquery name="lot_count" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
			...
			<cfquery name="pCont" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
