...
<cfform name="atts" method="post" enctype="multipart/form-data" action="BulkloadPartsTest.cfm">
...
<cfset colNames="">
	...
	<cflocation url="BulkloadPartsTest.cfm?action=validate">
</cfoutput>
</cfif>
<!------------------------------------------------------->
<!------------------------------------------------------->
...
<cfoutput>
	<cfquery name="bads" datasource="#Application.uam_dbo#">
	...
	<cfloop query="data">
		...
		<cflocation url="BulkloadPartsTest.cfm?action=checkValidate">
</cfoutput>
</cfif>
<!------------------------------------------------------->
<cfif #action# is "checkValidate">
	...
	<cfquery name="inT" datasource="#Application.uam_dbo#">
	...
	<cfquery name="allValid" datasource="#Application.uam_dbo#">
		select count(*) as cnt from cf_temp_parts where substr(validated_status,1,5) NOT IN
			('VALID','NOTE:')
	</cfquery>
	<cfif #allValid.cnt# is 0>
		<a href="BulkloadPartsTest.cfm?action=loadToDb">Load these parts....</a>
	<cfelse>
...
<cfoutput>
	...
	<cfif len(#use_part_id#) is 0 AND len(#parent_container_id#) gt 0>
		...
		<cfquery name="updateColl" datasource="#Application.uam_dbo#">
		...
		<cfquery name="newTiss" datasource="#Application.uam_dbo#">
