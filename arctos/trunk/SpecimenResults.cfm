...
<form name="controls">
	...
	<cfquery dbtype="query" name="smap">
		select cast(numberformat(dec_lat,"9.99") as varchar)  + "," + cast(numberformat(dec_long,"9.99") as varchar)  as coords from summary where dec_lat is not null group by  dec_lat,dec_long
	</cfquery>
