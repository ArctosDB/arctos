	...
	<table>
		<tr>
			<td>
				...
				<ul>
					<li>
						<a href="#mapurl#?isGeoreferenced=false">#val(numWillNotMap)# specimens</a> do not have coordinate and will not map.
					</li>
					<li>
						<a href="#mapurl#?min_max_error=NULL">#val(noerr.c)# specimens</a> have no indication of precision.
					</li>
