...
<div class="secDiv">
	<table class="ssrch">
		...
		<tr>
			...
			<div id="map_canvas" style="width: 60%px; height: 400px"></div>
...
<script language="javascript" type="text/javascript">
	function initializeMap() {
		if (GBrowserIsCompatible()) {
			...
			map.addControl(new DragZoomControl(boxStyleOpts, otherOpts, callbacks),new GControlPosition(G_ANCHOR_BOTTOM_RIGHT));
