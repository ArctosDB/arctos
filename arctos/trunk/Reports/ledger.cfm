...
<cfdocument
		...
		filename="#Application.webDirectory#/temp/ledger_#left(session.sessionid,10)#.pdf" overwrite="true">
...
<a href="/temp/ledger_#left(session.sessionid,10)#.pdf">Get the PDF</a><br />
</cfoutput>
