...
<!--- validate permit_num --->
	...
	<cfquery name="getPermitID" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
		#preservesinglequotes(sql)#
	</cfquery>
	<!--- debug code
...
<cfset sql="select
			...
			order by
				#order#">
<cfquery name="specimens" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
	#preservesinglequotes(sql)#
</cfquery>
...
<!---	<tr>
	...
	<tr>
		...
		<cfquery name="permit" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
			#preservesinglequotes(sql)#
		</cfquery>
