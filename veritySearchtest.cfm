<cfinclude template="/includes/_header.cfm">
	<form name="s" method="post" action="veritySearchtest.cfm">
   ...
   <p> <strong>Did you mean: <a href="veritySearchtest.cfm?criteria=#info.SuggestedQuery#&action=showResults&cats=#cats#">#info.SuggestedQuery#</a></p></strong>
  </cfif>
</cfoutput>
				<table border>
				<cfoutput query="res">
