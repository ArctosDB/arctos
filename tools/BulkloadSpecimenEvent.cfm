...
<cfif action is "makeTemplate">
	<cfset header="guid,ASSIGNED_BY_AGENT,ASSIGNED_DATE,SPECIMEN_EVENT_REMARK,SPECIMEN_EVENT_TYPE,COLLECTING_METHOD,COLLECTING_SOURCE,VERIFICATIONSTATUS,HABITAT,COLLECTING_EVENT_ID,VERBATIM_DATE,VERBATIM_LOCALITY,COLL_EVENT_REMARKS,BEGAN_DATE,ENDED_DATE,COLLECTING_EVENT_NAME,LAT_DEG,DEC_LAT_MIN,LAT_MIN,LAT_SEC,LAT_DIR,LONG_DEG,DEC_LONG_MIN,LONG_MIN,LONG_SEC,LONG_DIR,DEC_LAT,DEC_LONG,DATUM,UTM_ZONE,UTM_EW,UTM_NS,ORIG_LAT_LONG_UNITS,LOCALITY_ID,SPEC_LOCALITY,MINIMUM_ELEVATION,MAXIMUM_ELEVATION,ORIG_ELEV_UNITS,MIN_DEPTH,MAX_DEPTH,DEPTH_UNITS,MAX_ERROR_DISTANCE,MAX_ERROR_UNITS,LOCALITY_REMARKS,GEOREFERENCE_SOURCE,GEOREFERENCE_PROTOCOL,LOCALITY_NAME,GEOG_AUTH_REC_ID,HIGHER_GEOG">
	<cffile action = "write"
    file = "#Application.webDirectory#/download/BulkSpecimenEvent.csv"
    output = "#header#"
    addNewLine = "no">
	<cflocation url="/download.cfm?file=BulkSpecimenEvent.csv" addtoken="false">
</cfif>
<cfif action is  "nothing">
	Upload specimen-events
	<p>
		<a href="BulkSpecimenEvent.cfm?action=makeTemplate">download a CSV template</a>
	</p>
	<table border>
		<tr>
			<th>Column</th>
	...
	Upload a file:
	<cfform name="getFile" method="post" action="BulkSpecimenEvent.cfm" enctype="multipart/form-data">
...
<cfif action is "getFileData">
	<cfoutput>
		...
		<cflocation url="BulkSpecimenEvent.cfm?action=validateFromFile">
	</cfoutput>
</cfif>
