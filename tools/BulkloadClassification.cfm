...
-- 20170602: drop display_name it's now being autogenerated

alter table cf_temp_classification drop column display_name;
alter table cf_temp_classification modify remark varchar2(4000);


alter table CF_TEMP_CLASSIFICATION_FH drop column display_name;
alter table CF_TEMP_CLASSIFICATION_FH modify remark varchar2(4000);


alter table cf_temp_classification modify NOMENCLATURAL_CODE varchar2(255) null;
alter table CF_TEMP_CLASSIFICATION_FH modify NOMENCLATURAL_CODE varchar2(255) null;
alter table CF_TEMP_CLASSIFICATION_FH modify remark varchar2(4000);

."CF_TEMP_CLASSIFICATION_FH"."NOMENCLATURAL_CODE")
---->
