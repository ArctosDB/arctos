...
<cfif action is "validateFromFile">
	...
	<cfquery name="goodContainers" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
	...
	<cfoutput>
		<cfloop query="data">
			...
			<cfif sts is ''>
				<cfquery name="setter" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
			...
			<cfelse>
				<cfquery name="ssetter" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
					update cf_temp_barcode_parts set
						status='#sts#'
					where key=#key#
				</cfquery>
...
<cfif action is "load">
	...
	<cfelse>
		<cftransaction>
			<cfloop query="d">
				<cfquery name="flagIT" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
					update 
						container 
					set 
						print_fg=#print_fg#,
