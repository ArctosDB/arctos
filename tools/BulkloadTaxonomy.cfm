...
<cfoutput>
	...
	<ul>
		...
		<li>Cells where new term conflicts with old term have a <span style="border:2px solid red;">red border</span>. Pay special attention to them. Really. We mean it.</li>
	</ul>
