	...
	<cfoutput>
		<cfif not isdefined("forceOverride") or forceOverride is not true>
			...
			<cfif result.consensus is not "might_be_valid">
				...
				<p>
					<a href="editTaxonomy.cfm?action=cloneClassificationNewName_insert&newName=#newName#&taxon_name_id=#taxon_name_id#&CLASSIFICATION_ID=#CLASSIFICATION_ID#&forceOverride=true">
