...
<cfquery name="ctLoanStatus" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
...
<cfset thisYear = #dateformat(now(),"yyyy")#>
			...
			<cfquery name="ctLoanType" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
...
starting 1<cfflush>
			...
			<cfquery name="getLoanNum" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
		 ...
		 bla <cfflush>
					...
					getting specimens<cfflush>
						...
						<cfloop query="specs">
							...
							<cfquery name="thisItemInArctos" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
...
<cfif  #action# is "makeArctosLoan">
	...
	<cfoutput>
		...
		<cfquery name="TRANS_ENTERED_AGENT_ID" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionid)#">
