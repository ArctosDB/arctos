...
<cfquery name="ctLoanStatus" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cfset thisYear = #dateformat(now(),"yyyy")#>
			...
			<cfquery name="ctLoanType" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
starting 1<cfflush>
			...
			<cfquery name="getLoanNum" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
		 ...
		 bla <cfflush>
					...
					getting specimens<cfflush>
						...
						<cfloop query="specs">
							...
							<cfquery name="thisItemInArctos" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
							...
							<tr>
								...
								<td>#condition#</td>
								<td>#remark#</td>
								<cfquery name="ctUse" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cfif  #action# is "makeArctosLoan">
	...
	<cfoutput>
		...
		<cfquery name="TRANS_ENTERED_AGENT_ID" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
