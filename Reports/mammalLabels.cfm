...
<tr>
 <cfloop query="data">
	...
	<cfset borderClass = "bordBotDash">
	<cfif #i# neq #numCols#>
		<cfset borderClass = "#borderClass# bordRightDash">
	</cfif>
	<!----
	<cfif #t# lt ((#numRows# * #numCols#) - #numCols#)>
		<cfset borderClass = "#borderClass# ">
	</cfif>
	---->
	<td class="#borderClass#" width="20%"><!---- open cell table ---->
				<table cellpadding="0" cellspacing="0" width="100%" class="pad3 ">
					<tr>
						<td  colspan="2" class="times7bc">
							UAM #cat_num#&nbsp;<i>#Scientific_Name#</i>
						</td>
					</tr>
					<tr>
						<td colspan="2"  class="times7">
					...
					<tr>
						<td  class="times6">#coordinates#</td>
						<td  class="times7 alignR">
							<cfif len(#quad#) gt 0>
								[#quad#]&nbsp;
							</cfif>
						</td>
					...
					<tr>
						<td class="times7">#thisDate#</td>
						<td class="times7 alignR">#sexcode#&nbsp;</td>
					</tr>
					<tr>
						<td class="times7">#meas#</td>
						<td class="times7 alignR">#af#&nbsp;</td>
					</tr>
					<tr>
						<td colspan="2" class="times5">#stripParts#</td>						
					</tr>
					
					<tr>
						<td class="times7 ">#FieldNum#</td>
						<td class="times7  alignR">Accn #accn#&nbsp;</td>
					</tr>
				</table>
				<!--- end cell table --->
				</td><!--- end cell cell --->
