...
<cfif #action# is "saveEdit">
    ...
    <cfquery name="e" datasource="user_login" username="#client.username#" password="#decrypt(client.epw,cfid)#">
        ...
        sql_text ='#binaryencode(escapeQuotes(sql_text),"base64")#'
        where report_id=#report_id#
    </cfquery>
...
<cfif #action# is "edit">
    ...
    <form method="post" action="label_report.cfm">
        ...
        <textarea name="sql_text" id="sql_text" rows="40" cols="120" wrap="soft">#binarydecode(e.sql_text,"base64")#</textarea>
        <br>
