...
<form name="newID" method="post" action="a_editIdentification.cfm">
	      <input type="hidden" name="content_url" value="a_editIdentification.cfm">
...
<form name="id#thisIdentification_id#" method="post" action="a_editIdentification.cfm"  onSubmit="return gotAgentId(this.newIdById.value)">
				...
				<tr id="IdTr_#thisIdentification_id#_#agent_id#">
					...
					<td>
						<input type="text" 
							...
							class="reqdClr"
							size="50" 
							onchange="getAgent('IdById_#thisIdentification_id#_#agent_id#','IdBy_#thisIdentification_id#_#agent_id#','id#thisIdentification_id#',this.value); return false;"
				 			onKeyPress="return noenter(event);"> 
							<!---
...
<cfif #Action# is "deleteIdent">
  ...
  <cflocation url="a_editIdentification.cfm?collection_object_id=#collection_object_id#">
</cfif>
<!----------------------------------------------------------------------------------->
...
<cfloop list="#collection_object_id#" index="i">
	...
	<cflocation url="a_editIdentification.cfm?collection_object_id=#collection_object_id#&Action=multi">
