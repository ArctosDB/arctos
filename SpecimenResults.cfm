...
<script type='text/javascript' language="javascript" src='/includes/SpecimenResults.js?v=3.447'></script>
...
<cfoutput>
 ...
 if you still can't find what you need. We'll help if we can.
				</li>
			</ul>
		</div>
	</cfif>
