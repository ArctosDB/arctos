...
function setup_jplayer_end(audio_id, wrapper_id, mp3link, ogglink) {
    $(document).ready(function() {
        $("#" + audio_id).jPlayer({
            ...
            swfPath: "/js",
            supplied: "mp3, oga",
            cssSelectorAncestor: "#" + wrapper_id
        });
    });
}
...
function make_audio_html(i, unq_id_1, unq_id_2, unq_id_3, mp3link, ogglink) {
    ...
    html += 'To play this media, you need to update your browser.';
                        ...
                        theInnerHtml += '<div class="shortThumb"><div class="thumb_spcr">&nbsp;</div>';
                            ...
                            for (m=0; m<thisMedia.ROWCOUNT; ++m) {
                                ...
                                if (thisMedia.DATA.mimecat[m] != 'audio') {
                                    ...
                                    theInnerHtml += '<br><br><br><div class="mimeinfo" align="center">' + thisMedia.DATA.mimecat[m] + ' (' + thisMedia.DATA.mime_type[m] + ')' + '</div>';
...
//                                        '<img src="/images/audioNoThumb.png" class="theThumb"></a>';
                        ...
                        theInnerHtml += '<div class="thumb_spcr">&nbsp;</div>';
                        theInnerHtml += '</td>';
                    }
                    theInnerHtml += '<td>';
