...
<cfoutput>
	...
	<cfmail subject="#sub#" to="#Application.PageProblemEmail#" from="#frm#@#application.fromEmail#" type="html">
		...
		<br>The IP requesting the dead link was <a href="http://network-tools.com/default.asp?prog=network&host=#ipaddress#">#cgi.ipaddress#</a>
		 - <a href="http://arctos.database.museum/Admin/blacklist.cfm?action=ins&ip=#cgi.ipaddress#">blacklist</a>
