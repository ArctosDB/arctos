...
<cfif action is "deleteCard">
	<cfquery name="la" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cfif action is "findLoc">
	...
	<cfloop query="la">
		...
		<cfquery name="sp" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cfif action is "enterCard">
	<script src="/includes/jquery/jquery-autocomplete/jquery.autocomplete.pack.js" language="javascript" type="text/javascript"></script>
	<cfquery name="ctAge" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#" cachedwithin="#createtimespan(0,0,60,0)#">
		select 
			ATTRIBUTE_VALUE 
		from 
	...
	<cfquery name="ctFormation" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#" cachedwithin="#createtimespan(0,0,60,0)#">
		select 
			ATTRIBUTE_VALUE 
		from 
			geology_attribute_hierarchy 
	...
	<cfquery name="ctSeriesEpoch" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#" cachedwithin="#createtimespan(0,0,60,0)#">
		select 
			ATTRIBUTE_VALUE 
		from 
			geology_attribute_hierarchy 
	...
	<cfquery name="ctSystemPeriod" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#" cachedwithin="#createtimespan(0,0,60,0)#">
		select 
			ATTRIBUTE_VALUE 
		from 
			geology_attribute_hierarchy 
	...
	<cfquery name="ctErathemEra" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#" cachedwithin="#createtimespan(0,0,60,0)#">
		select 
			ATTRIBUTE_VALUE 
		from 
			geology_attribute_hierarchy 
...
<cfif action is "saveNew">
	...
	<cftransaction>
		...
		<br>barcode: #barcode#
			...
			<cfquery name="lid" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cfif action is "enterSpec">
	<script src="/includes/jquery/jquery-autocomplete/jquery.autocomplete.pack.js" language="javascript" type="text/javascript"></script>
	<cfquery name="card" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cfif action is "saveNewSpec">
	...
	<br>taxon_name	
		...
		<cfquery name="vP" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
