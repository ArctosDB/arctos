...
<cftry>
	...
	<cftransaction>
		<cfquery name="nr" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cftry>
	<cftransaction>
		<cfquery name="oldID" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
		...
		<cfquery name="idtax" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cfif len(#label#) gt 0>
	<cfquery name="nParent" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	...
	<cfquery name="newPart" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
		INSERT INTO specimen_part (
			...
			<cfif #thisPrintFlag# gt 0>
				<cfquery name="pfg" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
...
<cfset result = "success">
		...
		<cfquery name="idid" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
	...
	<cfset result = "success">
		...
		<cfif #isThere.recordcount# is 1 and len(#isThere.taxon_name_id#) gt 0>
			<cftry>
					...
					<cfelse>
						<cfquery name="idt" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
							update identification_taxonomy set
							taxon_name_id = #isThere.taxon_name_id#
							where identification_id = #idid.identification_id#
						</cfquery>
					
						<cfquery name="o" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey)#">
