 ...
 <cfloop query="data">
	...
	--->
		<div style=" border:1px dashed ##F2F2F2; position:absolute; left:#lPos#px; top: #tPos#px; width:#width#px; height:#height#px;" align="center">
			<div style="background-color:##0099CC; position:absolute; top:2px; left:2px; width:240px;
				height:10px; padding-left:2px; padding-right:2px;" align="center"  class="aria13b">
				University of Alaska Museum #cat_num#
				<!----
				<br />tPos: #tPos#; 
				<br />lPos: #lPos#;
			...
			<div style="background-color:##CC9933; position:absolute; top:14px; left:2px; width:240px;
				height:10px; padding-left:2px; padding-right:2px;" align="center"  class="arial10">
				<i>#Scientific_Name#</i>
			</div>
				<!----
	...
	<cfset t=#t#+1>	
	<cfset lPos = #lPos# + #width# + 60><!--- some padding between columns --->
