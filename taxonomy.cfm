		...
		<div class="sourceDiv">
			...
			<cfloop query="source_classification">
				<div class="classificationDiv">
					<cfif isdefined("session.roles") and listfindnocase(session.roles,"manage_taxonomy")>
						<a title="Create a copy of this classification using any "local" source under this name." href="/editTaxonomy.cfm?action=cloneClassification&taxon_name_id=#taxon_name_id.taxon_name_id#&name=#name#&classification_id=#classification_id#">[ Clone Classification ]</a>
