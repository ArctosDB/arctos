...
<cfoutput>
	<cfif action is "nothing">
		...
		<cfset locality="VERBATIM_DATE,BEGAN_DATE,ENDED_DATE,HIGHER_GEOG,SPEC_LOCALITY,VERBATIM_LOCALITY,ORIG_ELEV_UNITS,MAXIMUM_ELEVATION,MINIMUM_ELEVATION,LOCALITY_REMARKS,HABITAT_DESC,COLL_EVENT_REMARKS,DEPTH_UNITS,MIN_DEPTH,MAX_DEPTH,COLLECTING_METHOD,COLLECTING_SOURCE,COLL_OBJECT_HABITAT,ASSOCIATED_SPECIES,LOCALITY_ID,COLLECTING_EVENT_ID">
