...
<script>self.name='_agentDetail';</script>
...
<cfoutput>
<form name="prefdName" action="agents2.cfm" method="post">
...
<cfif #Action# is "newPerson">
	<form name="newPerson" action="agents2.cfm" method="post">
...
<cfquery name="elecagentAddrs" datasource="#Application.web_user#">
	...
	<tr>
		<td>
			<table>
				...
				<form name="addr#i#" method="post" action="agents2.cfm">
				...
				<tr>
					<td nowrap align="center">
						...
						<form name="kill#i#" method="post" action="agents2.cfm">
	...
	<tr>
		...
		<table>
			...
			<form name="elad#i#" method="post" action="agents2.cfm">
...
<cfoutput query="person">
<form name="editPerson" action="agents2.cfm" method="post">
	...
	<tr>
		<td>
			...
			<table border>
				...
				<cfset i=1>
				<cfloop query="grpMem">
					<form name="groupMember#i#" method="post" action="agents2.cfm">
						<input type="hidden" name="action" />
			...
			<form name="newGroupMember" method="post" action="agents2.cfm">
				<input type="hidden" name="agent_id" value="#agent_id#" />
...
<tr>
	<td>
		<table>
			<cfloop query="names">
			<cfoutput>
			<form name="a#name#" action="agents2.cfm" method="post">
			<input type="hidden" name="Action">
...
<tr>
	<td>
		<table class="newRec">
			...
			<cfoutput>
			 <form name="newName" action="agents2.cfm" method="post">
...
<tr>
    <td>
		<table>
			...
			<cfoutput>
			<cfloop query="relns">
			<form name="agentRelations#i#" method="post" action="agents2.cfm">
			  <input type="hidden" name="Action">
			  <input type="hidden" name="agent_id" value="#person.agent_id#">
...
<tr>
	<td>
		<table class="newRec">
			...
			<cfoutput>
			<form name="newRelationship" method="post" action="agents2.cfm">
...
<tr>
	<td colspan="2">
		...
		<cfoutput>
			<cfform name="newAddress" method="post" action="agents2.cfm">
				<input type="hidden" name="agent_id" value="#person.agent_id#">
				<input type="hidden" name="Action" value="newAddress">
					...
					<cfform name="newElecAddr" method="post" action="agents2.cfm">
...
<cfoutput>
<cfform name="edElecAddr" method="post" action="agents2.cfm">
...
<cfif #Action# is "saveEditElecAddr">
	<cfoutput>
		...
		<cflocation url="agents2.cfm?action=editAgent&agent_id=#agent_id#">
	</cfoutput>
</cfif>
<!------------------------------------------------------------------------------------------------------------->
<!------------------------------------------------------------------------------------------------------------->
...
Edit This Address:
<cfoutput>
<form name="editAddr" method="post" action="agents2.cfm">
				<input type="hidden" name="agent_id" value="#agent_id#">
...
<cfif #action# is "insertPerson">
 ...
 <!--- no security --->
	<cfoutput>
		...
		<cflocation url="agents2.cfm?action=editAgent&agent_id=#agentID.nextAgentId#">
