    	...
    	<tr>
            ...
            <td>
				<cfif accepted_id_fg is 1 and taxa_formula is 'A {string}'>
					...
					<input id="scientific_name_#i#" name="scientific_name_#i#" value="#stripQuotes(scientific_name)#" class="minput reqdClr">
					<br>
					<label for="x">
	...
	<cftransaction>
		<cfloop from="1" to="#NUMBER_OF_IDS#" index="n">
			...
			<cfloop list="#form.fieldnames#" index="i">
				...
				---->
				<cfif listlen(i,"_") is 4 and listgetat(i,1,"_") is "CITATION_ID" and listgetat(i,2,"_") is thisIdentificationId>
					<br>#i# is a citation
				</cfif>
			</cfloop>
