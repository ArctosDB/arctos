...
<cfif action is "editProject">
	...
	<cfoutput>
		...
		<cfquery name="getLoans" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
			select 
		...
		<cfquery name="publications" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
			SELECT 
...
<cfif action is "save">
	<cfoutput>
  		<cfquery name="upProject" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
 			UPDATE project SET
		...
		<cfloop from="1" to="#numberOfAgents#" index="n">
			...
			<cfif agent_name is "deleted">
				<cfquery name="deleAgnt" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
	 				DELETE FROM project_agent where project_agent_id=#project_agent_id#
				</cfquery>
			<cfelse>
				<cfquery name="upProjAgnt" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
...
<cfif action is "removeTaxonomy">
	<cfoutput>
		<cfquery name="addtaxon" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
...
<cfif #Action# is "deleteProject">
 <cfoutput>
 	<cfquery name="isAgent"	 datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
	...
	<cfquery name="isTrans"	 datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
	...
	<cfquery name="killProj" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
...
<cfif #Action# is "saveAgentChange">
 <cfoutput>
 <cfquery name="upProj" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
 	UPDATE project_agent SET
...
<cfquery name="newPub" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
