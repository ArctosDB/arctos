...
<cfoutput> 
	<cfquery name="getColls" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
		SELECT 
	...
	<cfoutput>
		<cftransaction>
			<cfif coll_order is "first" and collector_role is 'c'>
				...
				<cfquery name="bumpAll" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
					update 
						collector 
					set 
				...
				<cfloop list="#collection_object_id#" index="i">
					<cfquery name="insOne" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
			...
			<cfelseif coll_order is "last" and collector_role is 'c'>
				...
				<cfloop list="#collection_object_id#" index="i">
					<cfquery name="max" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
		...
		<cftransaction>
			<cfloop list="#collection_object_id#" index="i">
				...
				<cfif max.collection_object_id gt 0>
					...
					<cfquery name="inc" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,jsessionid)#">
						update 
							collector 
						set
							coll_order=coll_order -1
