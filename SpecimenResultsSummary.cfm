...
<cfquery name="SpecRes#left(session.sessionid,10)#" dbtype="query" cachedwithin="#createtimespan(0,0,60,0)#">
	select * from getData
</cfquery>
...
<cfquery name="getBasic" dbtype="query">
	select * from SpecRes#left(session.sessionid,10)# order by #order_by#
</cfquery>
