...
<cfquery name="thisLocIDs" dbtype="query">
                        ...
                        <tr>
                            <td>
								...
								<a href="duplicateLocality.cfm?action=delete&returnlocalityid=#locality_id#&returnAction=detectdups&locality_id=#goodLocID.locality_id#&deleteLocalityID=#valuelist(badLocID.locality_id)#">[&nbsp;merge&nbsp;all&nbsp;]</a>
