...
<cfif isdefined("locality_id") and len(locality_id) gt 0>
	<cfset qual = "#qual# AND locality.locality_id in ( #locality_id# )">
</cfif>
...
<cfif isdefined("collecting_event_id") and len(collecting_event_id) gt 0>
	<cfset qual = "#qual# AND collecting_event.collecting_event_id = #val(collecting_event_id)# ">
</cfif>
...
<cfif isdefined("island_group") and len(#island_group#) gt 0>
	<cfset qual = "#qual# AND island_group = '#escapeQuotes(island_group)#'">
</cfif>
