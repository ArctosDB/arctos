...
<cfdump var=#listcontainsnocase(Application.mobileURL,request.rdurl,"/")#>
				...
				redirecting to mobile because magic	<cfabort>
				<cfset z="/dm.cfm?r=" & mdflip(request.rdurl)>
				<cflocation url="#z#" addtoken="false">
			</cfif>
		</cfif>
