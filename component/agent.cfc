...
<cffunction name="checkAgent" access="remote" returnformat="json">
	...
	<cfset temp=ArrayAppend(nvars, listToArray('Alexandria,Alexandra,Sandy,Sasha,Cassandra,Cassie,Cassy,Alexander,Alec,Alex,Sasha'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Allen,Alan,Al'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Amanda,Manda,Mandy'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Amos,Moses'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Andrew,Andy,Drew'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Angela,Angie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Anna,Ann,Anna,Hannah,Anne,Annie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Anthony,Tony'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Arthur,Art,Arturo,Artie'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Barbara,Barb,Barby,Barbie,Babs'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Barnabas,Barnard,Bernard,Bernie,Berny'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Bartholomew,Bart'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Benjamin,Ben,Benny'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Beverly,Bev'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Bradford,Brad,Bradly'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Brian,Bryan,Bryant'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Caleb,Cal'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Charles,Charlie,Charley,Chuck,Chaz'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Christopher,Chris'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Curtis,Curt,Kurtis,Kurt'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Cynthia,Cindi,Cindy'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Carolyn,Carol,Carrie,Cary'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Daniel,Dan,Danny'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Danielle,Danelle'))>
	<cfset temp=ArrayAppend(nvars, listToArray('David,Dave,Davey'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Deborah,Deb,Debbie,Debby,Debra'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Dennis,Denny'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Donald,Don,Donny'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Douglas,Doug'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Dorothy,Dot,Dottie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Duane,Dewayne,Dwayne,Dwane'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Dusty,Dustin'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Earnest,Ernest,Erny,Ernie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Edmund,Edward,Ed,Edgar,Eddy,Eddie,Edwin,Ted'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Egbert,Bert,Burt'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Elaine,Eleanor'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Elizabeth,Liz,Beth,Betty'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Eugene,Gene'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Frank,Franklin,Frances'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Gabriel,Gabe,Gabby,Gabbie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('George,Jorge'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Gerald,Jerry,Gerry'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Gregory,Greg,Gregg'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Howard,Hal,Howie'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Irwin,Erwin'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Jacob,Jake,Jakob'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Jacqueline,Jacky,Jackie,Jaclyn,Jacklyn'))>
	<cfset temp=ArrayAppend(nvars, listToArray('James,Jamie,Jamey,Jim,Jimmy,Jimmie,Jay'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Janet,Jan'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Jeffrey,Joffrey,Jeff,Joff'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Jennifer,Jenny,Jennie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Jessica,Jess,Jesse,Jessy,Jessie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('John,Jon,Hans,Ian,Ivan,Jack,Jan,Jean,Jaques,Jock,Johnathan,Jonathan,Johnny,Jonny'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Joseph,Joe,Jose,Joey'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Joshua,Josh'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Joyce,Joy'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Judith,Judy'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Katherine,Katarina,Kathleen,Cathy,Kat,Kitty,Kate,Katy,Katie,Kayey,Kathy,Kathey,Kit,Cathleen,Catherine,Kathryn,Katherina,Kathe,Katrina'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Kenneth,Ken,Kenney,Kenny'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Kimberly,Kimberly,Kimberlee,Kim,Kym,Kimmy,Kimmie'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Lauryn,Laurie,Lorrie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Leonard,Leo,Leon,Len,Lenny,Lennie,Lineau,Lenhart'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Leroy,Lee,Roy'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Leslie,Les,Lester'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Lillian,Lil,Lilly,Lillie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Lincoln,Link'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Linda,Lynn,Lynette,Linette'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Lois,Louise'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Louis,Lewis,Lou,Louie'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Margaret,Maggy,Maggie,Marge,Peg,Peggy,Peggie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Matthew,Matt,Matthias'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Michael,Mickey,Micky,Mike,Mitchell,Micah,Mick'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Michelle,Mickey,Micky,Shelley,Shelly'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Megan,Meg'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Nicholas,Nick,Nicky,Nico'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Nathan,Nathaniel,Nat,Nate'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Pamela,Pam'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Patricia,Pat,Tricia,Patsy,Patsie,Pattie,Patty,Trixie,Trixi,Trixy,Trish,Tish'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Patrick,Paddie,Paddy,Paddey,Pat,Patsie,Patsy,Peter,Patricia,Pate'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Paulina,Paula,Pollie,Polly,Lina,Pauline'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Peter,Pete,Petey,Pate'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Rebecca,Becka,Becky'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Richard,Dick,Rich,Rick,Richey,Dickon,Dickson,Ricky,Rickey'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Robert,Dob,Dobbin,Bob,Bobby,Bobbie,Rob,Robin,Rupert,Hob,Hobkin,Robbie,Robby'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Rodney,Rod,Ronald'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Raymond,Ray'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Samuel,Sam,Sammy,Sammey,Samantha,Samson'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Sharon,Sharyn,Sharrey,Sharrie,Sharry,Shar,Sharey,Sharie,Sheron,Sheryn,Sheryl,Cheryl'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Shaun,Sean,Shawn,Shane,Shayne'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Stephen,Steve,Steven'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Stephanie,Steph,Steffi,Stephy,Steffy'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Susan,Sue,Susie,Suzy'))>
	
	
	<cfset temp=ArrayAppend(nvars, listToArray('Theodore,Ted,Theodrick,Theodorick,Tad,Theo,Teddy,Teddie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Theresa,Therese,Terry,Terrie,Tess Tessy,Tessie,Thursa,Teresa,Thirsa,Tessa'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Thomas,Thom,Tom,Tommy,Tommie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Timothy,Tim,Timmy,Timmey,Timmie'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Vanessa,,Nessa,Vanna'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Victor,Vic.Vick'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Victoria,Vickie,Vickey,Vicky'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Vincent,Vin,Vince,Vinnie,Vinny'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Virgil,Virg'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Walter,Walt'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Wesley,Wes'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Wilber,Will,Wilbert'))>
	<cfset temp=ArrayAppend(nvars, listToArray('William,Bill,Will,Willy,Willie,Billy,Billie,Bell,Bela,Willie,WIlly,Wilhelm,Willis'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Virginia,Ginger,Ginny,Jane,Jenni,Jenny,Gina'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Yolanda,Yolonda'))>
	
	<cfset temp=ArrayAppend(nvars, listToArray('Zachariah,Zach,Zacharias,Zachary,Zeke'))>
	<cfset temp=ArrayAppend(nvars, listToArray('Zebedee,Zebulon,Zeb'))>
