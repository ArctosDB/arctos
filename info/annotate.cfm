...
<cfoutput>
	...
	<form name="annotate" method="post" action="/info/annotate.cfm">
		...
		<div style="margin:.3em;">
			...
			<input type="text" class="reqdClr" name="email" id="email" value="#email#" size="60" oninvalid="setCustomValidity('Please provide a valid email address where we can contact you with any questions regarding your annotation.
				Any information you provide will be used only for this purpose.')">
		</div>
		<br>
