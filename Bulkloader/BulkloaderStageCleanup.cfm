...
<cfif action is "nothing">
	...
	<ul>
		...
		<li>You have no idea what you're trying to do. (This form will mess up all your data at once.)</li>
	</ul>
	What does this form do?
	<ul>
		<li>Writes a SQL statement and applies it to bulkloader_stage.</li>
	</ul>
	<form name="x" method="" action="">
