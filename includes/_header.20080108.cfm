...
<div id="header_color" style='background-color:#Client.header_color#;'>
	...
	<table width="95%" cellpadding="0" cellspacing="0" border="0" id="headerContent">
		<tr>
			<td width="95" nowrap="nowrap" class="headerImageCell">
	...
	<li><h2>Add</h2>
		<ul>
			...
			<cfif listfind(formList,"/EditContainer.cfm")>
				<li><a target="_top" href="##" class="x">Containers</a>
					<ul>
			...
			<cfif listfind(formList,"/Loan.cfm")>
				<li><a target="_top" href="##" class="x">Transactions</a>
					<ul>
						<li><a target="_top" href="/newAccn.cfm">Accession</a></li>
						<li><a target="_top" href="/Loan.cfm?Action=newLoan">Loan</a></li>
						<li><a target="_top" href="/borrow.cfm?action=new">Borrow</a></li>
						<li><a target="_top" href="/Permit.cfm?action=newPermit">Permit</a></li>
					</ul>
				</li>
			</cfif>
			<cfif listfind(formList,"/Locality.cfm")>
				<li><a target="_top" href="##" class="x">Location</a>
					<ul>
						<li><a target="_top" href="/Locality.cfm?action=newHG">Geography</a></li>
						<li><a target="_top" href="/Locality.cfm?action=newLocality">Locality</a></li>
					</ul>
				</li>			
			</cfif>			
	...
	<li><h2>Update</h2>
		<ul>
			...
			<cfif listfind(formList,"/Locality.cfm")>
				<li><a target="_top" href="##" class="x">Location</a>
					<ul>
						<li><a target="_top" href="/Locality.cfm?action=findHG">Geography</a></li>
						<li><a target="_top" href="/Locality.cfm?action=findLO">Locality</a></li>
						<li><a target="_top" href="/Locality.cfm?action=findCO">Event</a></li>
					</ul>
				</li>
			</cfif>
			<cfif listfind(formList,"/editAccn.cfm")>
				<li><a target="_top" href="##" class="x">Transaction</a>
					<ul>
						<li><a target="_top" href="/editAccn.cfm">Accession</a></li>
						<li><a target="_top" href="/Loan.cfm?Action=addItems">Loan</a></li>
						<li><a target="_top" href="/borrow.cfm">Borrow</a></li>
						<li><a target="_top" href="/Permit.cfm">Permit</a></li>
					</ul>
				</li>
			</cfif>
