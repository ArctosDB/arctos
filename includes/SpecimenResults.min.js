...
function insertTypes(a){var b=document.createElement("DIV");b.id="ajaxStatus";b.className="ajaxStatus";b.innerHTML="Checking for Types...";document.body.appendChild(b);jQuery.getJSON("/component/SpecimenResults.cfc",{method:"getTypes",idList:a,returnformat:"json",queryformat:"column"},function(a){var b=document.getElementById("ajaxStatus");try{b.innerHTML="Processing Types....";for(i=0;i<a.ROWCOUNT;++i){var c=a.DATA.TYPELIST[i],f="CatItem_"+a.DATA.COLLECTION_OBJECT_ID[i];if(0<f.length){var g=document.getElementById(f);
g.innerHTML+='<div class="showType">'+c+"</div>"}}document.body.removeChild(b)}catch(h){}document.body.removeChild(b)})}
