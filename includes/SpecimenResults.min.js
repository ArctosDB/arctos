...
"position",["center","center"])})});function closeCustom(){var a="/SpecimenResults.cfm?"+$("#mapURL").val();window.location=a}function getPostLoadJunk(){var a=[];$("div[id^='CatItem_']").each(function(){var b=this.id.split("_")[1];a.push(b)});var b=a.toString();insertMedia(b);insertTypes(b);injectLoanPick();displayMedia();formatPartDetail()}
function formatPartDetail(){$("div[id^='partdetail_']").each(function(){var a=$.parseJSON($("#"+this.id).html());a=JSON.stringify(a,null,2);$("#"+this.id).html("<pre>"+a+"</pre>")})}
...
"</table>",$("#CatItem_"+b).append(d))});$("#ajaxStatus").remove()}))}
