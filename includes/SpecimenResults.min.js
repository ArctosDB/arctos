...
function unexpPartDet(){$("div[id^='partdetail_']").each(function(){$(this).removeClass("noshrink")});$("#pdcb").remove();$("#ssControl").append('<input type="button" id="pdcb" value="Expand Part Detail" class="clrBtn" onclick="expPartDet()">')}function expPartDet(){$("div[id^='partdetail_']").each(function(){$(this).addClass("noshrink")});$("#pdcb").remove();$("#ssControl").append('<input type="button" id="pdcb" value="Collapse Part Detail" class="clrBtn" onclick="unexpPartDet()">')}
function formatPartDetail(){$('div[id^="partdetail_"]').length&&($("div[id^='partdetail_']").each(function(){var a=$.parseJSON($("#"+this.id).html());a=JSON.stringify(a,null,2);$("#"+this.id).html("<pre>"+a+"</pre>")}),$("#ssControl").append('<input type="button" id="pdcb" value="Expand Part Detail" class="clrBtn" onclick="expPartDet()">'))}
