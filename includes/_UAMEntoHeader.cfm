...
<div style='background-color:##a4bd5f;'>
		...
		<table width="95%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="90" nowrap>
					...
					<a href="http://www.uaf.edu/museum/ento/index.html"><img src="/images/butterfly.gif" alt="Arctos" border="0" height="80" width="90"></a>
				</td>
				<td align="left">
					<table>
						<tr>
						...
						<tr>
							<td align="left" nowrap>
							<a href="http://www.uaf.edu/museum/ento/index.htmll" >
										<span style="font-family:Arial, Helvetica, sans-serif;  font-size:24px;
		color:##000066;">Entomology Collection</span>
									</a>
								<br>
