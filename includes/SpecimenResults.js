...
function createMarker(p) {
	...
	contentString += '<br><a target="_blank" href="/SpecimenResults.cfm?coordinates=' + lat + ',' + lon + '">specimens @ coordinates (new window)</a>';
...
function pickedTool(){	
	...
	if (v=='BerkeleyMapper'){
		...
		openWindow("/bnhmMaps/bnhmMapData.cfm?showRangeMaps=true&" + $("#mapURL").val());
	} else if (v=='google') {
