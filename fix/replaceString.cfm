...
<cfset theNewFile = replace(theFile,'datasource="##Application.uam_dbo##">','datasource="user_login" username="##session.username##" password="##decrypt(session.epw,session.sessionKey)##">',"all")>
#theFile#
