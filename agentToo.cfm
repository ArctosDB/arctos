...
<cfoutput>
Find Agents:
<form name="agntSearch" action="agentToo.cfm" method="post">
		...
		<td colspan="2" align="center">
			...
			<input type="reset" 
				...
				<input type="button" 
					...
					onClick="document.location='agentToo.cfm?action=newPerson';">
				<input type="button" 
					value="New Other Agent" 
					class="insBtn"
					onmouseover="this.className='insBtn btnhov'"
					onmouseout="this.className='insBtn'"
					onClick="document.location='agentToo.cfm?action=newOtherAgent';">
		</td>
	</tr>
</table>
</form>
...
<cfset sql = "#sql# ORDER BY preferred_agent_name.agent_name">
	...
	<cfelse>
		...
		<cfloop query="getAgents">
			<a href="agentToo.cfm?action=editAgent&agent_id=#agent_id#">
...
<cfoutput>
<form name="prefdName" action="agentToo.cfm" method="post">
...
<cfif #Action# is "newPerson">
	<form name="newPerson" action="agentToo.cfm" method="post">
...
<cfquery name="elecagentAddrs" datasource="#Application.web_user#">
	...
	<tr>
		<td>
			<table>
				...
				<form name="addr#i#" method="post" action="agentToo.cfm">
				...
				<tr>
					<td nowrap align="center">
						...
						<form name="kill#i#" method="post" action="agentToo.cfm">
	...
	<tr>
		...
		<table>
			...
			<form name="elad#i#" method="post" action="agentToo.cfm">
...
<cfoutput query="person">
<form name="editPerson" action="agentToo.cfm" method="post">
	...
	<tr>
		<td>
			...
			<table border>
				...
				<cfset i=1>
				<cfloop query="grpMem">
					<form name="groupMember#i#" method="post" action="agentToo.cfm">
						<input type="hidden" name="action" />
			...
			<form name="newGroupMember" method="post" action="agentToo.cfm">
				<input type="hidden" name="agent_id" value="#agent_id#" />
...
<tr>
	<td>
		<table>
			<cfloop query="names">
			<cfoutput>
			<form name="a#name#" action="agentToo.cfm" method="post">
			<input type="hidden" name="Action">
...
<tr>
	<td>
		<table class="newRec">
			...
			<cfoutput>
			 <form name="newName" action="agentToo.cfm" method="post">
...
<tr>
    <td>
		<table>
			...
			<cfoutput>
			<cfloop query="relns">
			<form name="agentRelations#i#" method="post" action="agentToo.cfm">
			  <input type="hidden" name="Action">
			  <input type="hidden" name="agent_id" value="#person.agent_id#">
...
<tr>
	<td>
		<table class="newRec">
			...
			<cfoutput>
			<form name="newRelationship" method="post" action="agentToo.cfm">
...
<tr>
	<td colspan="2">
		...
		<cfoutput>
			<cfform name="newAddress" method="post" action="agentToo.cfm">
				<input type="hidden" name="agent_id" value="#person.agent_id#">
				<input type="hidden" name="Action" value="newAddress">
					...
					<cfform name="newElecAddr" method="post" action="agentToo.cfm">
...
<cfoutput>
<cfform name="edElecAddr" method="post" action="agentToo.cfm">
...
<cfif #Action# is "saveEditElecAddr">
	<cfoutput>
		...
		<cflocation url="agentToo.cfm?action=editAgent&agent_id=#agent_id#">
	</cfoutput>
</cfif>
<!------------------------------------------------------------------------------------------------------------->
<!------------------------------------------------------------------------------------------------------------->
...
Edit This Address:
<cfoutput>
<form name="editAddr" method="post" action="agentToo.cfm">
				<input type="hidden" name="agent_id" value="#agent_id#">
...
<cfif #action# is "insertPerson">
 ...
 <!--- no security --->
	<cfoutput>
		...
		<cflocation url="agentToo.cfm?action=editAgent&agent_id=#agentID.nextAgentId#">
